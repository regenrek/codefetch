...
async function generateProjectDocumentation(projectPath = '.') {
  ...
  try {
    ...
    const componentDocs = componentFiles.length > 0 ? await generateMarkdown(componentFiles.slice(0, 10), {
      maxTokens: 10000,
      projectTree: 0,
      tokenEncoder: 'cl100k',
