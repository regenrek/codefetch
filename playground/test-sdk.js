...
console.log('Supported Models sample:', Array.from(SUPPORTED_MODELS).slice(0, 3));
console.log('Default Ignore Patterns (first 5 lines):', DEFAULT_IGNORE_PATTERNS.split('\n').slice(0, 5).join('\n'));
...
try {
  const ig = ignore().add(DEFAULT_IGNORE_PATTERNS.split('\n').filter(line => line && !line.startsWith('#')));
